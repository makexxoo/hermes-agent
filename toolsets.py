...
TOOLSETS = {
    ...
    "hermes-iris": {
        "description": "IRIS WebSocket bridge — proxy gateway to Feishu/Weixin/other upstream clients",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
